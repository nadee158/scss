...
public class Exports extends AuditEntity implements Serializable {
	...
	public String toString() {
		return "Exports [exportID=" + exportID + ", container=" + container + ", commonGateInOut=" + commonGateInOut
				...
				+ referTemp + ", imdg=" + imdg + ", dgUNCode=" + dgUNCode + ", imdgLabelID=" + imdgLabelID + ", oogOH="
				+ oogOH + ", oogOL=" + oogOL + ", oogOF=" + oogOF + ", oogOA=" + oogOA + ", containerPosition="
				...
				+ ", vesselCode=" + vesselCode + ", vesselName=" + vesselName + ", expAgent=" + expAgent
				+ ", vesselStatus=" + vesselStatus + ", shipCode=" + shipCode + ", vesselSCN=" + vesselSCN
				+ ", vesselETADate=" + vesselETADate + ", vesselATADate=" + vesselATADate + ", shippingAgent=" + shippingAgent
				+ ", oogSSR=" + oogSSR + ", overClosingSSR=" + overClosingSSR + ", replanSSR=" + replanSSR
				+ ", ssrBlockStatus=" + ssrBlockStatus + ", ssrBlockStatusDate=" + ssrBlockStatusDate
