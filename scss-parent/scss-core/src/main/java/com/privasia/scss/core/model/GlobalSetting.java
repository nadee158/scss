...
public class GlobalSetting extends AuditEntity implements Serializable {
	...
	@Column(name = "GLB_MAIN_GATE_CUSTOM_CHECK")
	@Type(type = "yes_no")
	private boolean mainGateCustomCheck;
	...
	public boolean isMainGateCustomCheck() {
		return mainGateCustomCheck;
	}

	public void setMainGateCustomCheck(boolean mainGateCustomCheck) {
		this.mainGateCustomCheck = mainGateCustomCheck;
	}
