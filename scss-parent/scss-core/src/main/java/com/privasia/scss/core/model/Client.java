 ...
 */
@Entity
@Table(name="SCSS_CLIENT", uniqueConstraints={
		@UniqueConstraint(columnNames={"CLI_WEB_IPADDR"}),
		@UniqueConstraint(columnNames={"CLI_SCR_IPADDR"}),
		@UniqueConstraint(columnNames={"CLI_LPS_IPADDR"}),
