...
public class WHODD extends AuditEntity implements Serializable {
  ...
  private String reviseHeadNoRem;
  ...
  @AssociationOverrides({@AssociationOverride(name = "hdbsBkgDetailNo",
      joinColumns = @JoinColumn(name = "HDBS_STATUS1", referencedColumnName = "BKG_DETAIL_ID", nullable = true) )})
  ...
  @AssociationOverrides({
      @AssociationOverride(name = "hdbsBkgDetailNo", joinColumns = @JoinColumn(name = "HDBS_BKG_DETAIL_NO_2",
          referencedColumnName = "BKG_DETAIL_ID", nullable = true) )})
