...
public final class ModelMapPropertyMap {
  ...
  /*
   * public static PropertyMap<ReferRejectDTO, ReferReject> referRejectDTOToReferReject() { return
   * new PropertyMap<ReferRejectDTO, ReferReject>() { protected void configure() {
   ...
   * skip().getBaseCommonGateInOut().setGateOutClient(null); skip().setCompany(null); } }; }
   */
