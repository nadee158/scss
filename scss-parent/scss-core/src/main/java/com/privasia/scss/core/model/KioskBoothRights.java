...
public class KioskBoothRights extends AuditEntity implements Serializable {
	...
	public boolean equals(Object other) {
		if (this == other)
			return true;
		if (!(other instanceof KioskBoothRights))
			return false;

		KioskBoothRights otherKBR = (KioskBoothRights) other;

		boolean boothIDEquals = Objects.equals(getKioskBoothRightsID().getBooth().getClientID(),
				otherKBR.getKioskBoothRightsID().getBooth().getClientID());
		boolean kioskIDEquals = Objects.equals(getKioskBoothRightsID().getKiosk().getClientID(),
				otherKBR.getKioskBoothRightsID().getKiosk().getClientID());
