...
public class ModelMapEnumConverter {
  ...
  public static Converter<Integer, SolasWeightTypeSize> convertIntegerToSolasWeightTypeSize() {
    return new Converter<Integer, SolasWeightTypeSize>() {
      @Override
      public SolasWeightTypeSize convert(MappingContext<Integer, SolasWeightTypeSize> context) {
        if (context.getSource() != null) {
          switch (context.getSource()) {
            case 0:
              return SolasWeightTypeSize.SIZE_0;
            case 20:
              return SolasWeightTypeSize.SIZE_20;
            case 40:
              return SolasWeightTypeSize.SIZE_40;
            case 45:
              return SolasWeightTypeSize.SIZE_45;
            default:
              return SolasWeightTypeSize.SIZE_0;
          }
        } else {
  ...
  public static Converter<SolasWeightTypeSize, String> convertSolasWeightTypeSizeToInteger() {
    return new Converter<SolasWeightTypeSize, String>() {
      @Override
      public String convert(MappingContext<SolasWeightTypeSize, String> context) {
        if (context.getSource() != null) {
          switch (context.getSource()) {
            case SIZE_0:
              return SolasWeightTypeSize.SIZE_0.getValue();
            case SIZE_20:
              return SolasWeightTypeSize.SIZE_20.getValue();
            case SIZE_40:
              return SolasWeightTypeSize.SIZE_40.getValue();
            case SIZE_45:
              return SolasWeightTypeSize.SIZE_45.getValue();
            default:
              return SolasWeightTypeSize.SIZE_0.getValue();
          }
        } else {
  ...
  //@formatter:off
/*
	public static Converter<SolasWeightTypeSize, Integer> convertSolasWeightTypeSizeToInteger() {
		return new Converter<SolasWeightTypeSize, Integer>() {
			@Override
			public Integer convert(MappingContext<SolasWeightTypeSize, Integer> context) {
				if (context.getSource() != null) {
					switch (context.getSource()) {
					case SIZE_0:
						return Integer.parseInt(SolasWeightTypeSize.SIZE_0.getValue());
					case SIZE_20:
						return Integer.parseInt(SolasWeightTypeSize.SIZE_20.getValue());
					case SIZE_40:
						return Integer.parseInt(SolasWeightTypeSize.SIZE_40.getValue());
					case SIZE_45:
						return Integer.parseInt(SolasWeightTypeSize.SIZE_45.getValue());
					default:
						return null;
					}
				} else {
...
*/
	//@formatter:on
  public static Converter<String, SolasWeightType> convertStringToSolasWeightType() {
    return new Converter<String, SolasWeightType>() {
      @Override
      public SolasWeightType convert(MappingContext<String, SolasWeightType> context) {
        if (StringUtils.isNotBlank(context.getSource())) {
          switch (context.getSource()) {
            case "FUEL":
              return SolasWeightType.FUEL;
            case "TYRE":
              return SolasWeightType.TYRE;
            case "PM":
              return SolasWeightType.PM;
            case "MGW":
              return SolasWeightType.MGW;
            case "TRAILER":
              return SolasWeightType.TRAILER;
            case "VARIANCE":
              return SolasWeightType.VARIANCE;
            default:
              return null;
          }
        } else {
  ...
  public static Converter<SolasWeightType, String> convertSolasWeightTypeToString() {
    return new Converter<SolasWeightType, String>() {
      @Override
      public String convert(MappingContext<SolasWeightType, String> context) {
        if (context.getSource() != null) {
          switch (context.getSource()) {
            case FUEL:
              return SolasWeightType.FUEL.getValue();
            case TYRE:
              return SolasWeightType.TYRE.getValue();
            case PM:
              return SolasWeightType.PM.getValue();
            case MGW:
              return SolasWeightType.MGW.getValue();
            case TRAILER:
              return SolasWeightType.TRAILER.getValue();
            case VARIANCE:
              return SolasWeightType.VARIANCE.getValue();
            default:
              return null;
          }
        } else {
