...
public interface ExportsRepository extends BaseRepository<Exports, Long>, QueryDslPredicateExecutor<Exports> {
  ...
  public Optional<List<Exports>> fetchInProgressTransaction(@Param("cardID") long cardId,
