...
public class CustomsReport extends AuditEntity implements Serializable {
  ...
  @AssociationOverrides({
      @AssociationOverride(name = "gatePassID",
          joinColumns = @JoinColumn(name = "GATE_PASS_NO1", referencedColumnName = "GTP_PASSNO", nullable = true) ),
      @AssociationOverride(name = "exportID", joinColumns = @JoinColumn(name = "EXP_EXPORTNO_SEQ1",
  ...
  @AssociationOverrides({
      @AssociationOverride(name = "gatePassID",
          joinColumns = @JoinColumn(name = "GATE_PASS_NO2", referencedColumnName = "GTP_PASSNO", nullable = true) ),
      @AssociationOverride(name = "exportID", joinColumns = @JoinColumn(name = "EXP_EXPORTNO_SEQ2",
          referencedColumnName = "EXP_EXPORTNO_SEQ", nullable = true) )})
