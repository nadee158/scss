...
public class ReferRejectDetail extends AuditEntity implements Serializable {
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "referRejectDetail", cascade = CascadeType.ALL)
	private Set<SupervisorReferRejectReason> supervisorReferRejectReason;
	...
	public Set<SupervisorReferRejectReason> getSupervisorReferRejectReason() {
		return supervisorReferRejectReason;
	}

	public void setSupervisorReferRejectReason(Set<SupervisorReferRejectReason> supervisorReferRejectReason) {
		this.supervisorReferRejectReason = supervisorReferRejectReason;
	}
