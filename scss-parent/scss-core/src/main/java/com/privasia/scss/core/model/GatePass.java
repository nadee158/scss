...
@AttributeOverrides({
    @AttributeOverride(name="addBy",
                       column=@Column(name="GTP_ADD_BY")),
    @AttributeOverride(name="updateBy",
                       column=@Column(name="GTP_UPDATE_BY")),
    @AttributeOverride(name="dateTimeAdd",
    				   column=@Column(name="GTP_DATECREATE")),
    @AttributeOverride(name="dateTimeUpdate",
                       column=@Column(name="GTP_DATEUPDATE"))
})
public class GatePass extends AuditEntity implements Serializable {
	...
	@AttributeOverrides({
		        @AttributeOverride(
		            ...
		            column = @Column( name = "GTP_CONTAINERNO")
		        ),
		        @AttributeOverride(
		            name = "containerISOCode",
		            column = @Column( name = "GTP_CONT_ISO_CODE")
		        ),
		        @AttributeOverride(
		            name = "containerLength",
		            column = @Column( name = "CONT_LENGTH")
		        ),
		        @AttributeOverride(
		            name = "containerFullOrEmpty",
		            column = @Column( name = "GTP_FULLEMPTYFLAG")
		        )
	})
	...
	@AttributeOverrides({
		        @AttributeOverride(
		            name = "card",
		            column = @Column( name = "GTP_HCTDID")
		        ),
		        @AttributeOverride(
		            name = "gateInClerk",
		            column = @Column( name = "GTP_GATEINCLERKID")
		        ),
		        @AttributeOverride(
		            name = "timeGateIn",
		            column = @Column( name = "GTP_TIMEGATEIN")
		        ),
		        @AttributeOverride(
		            name = "timeGateInOk",
		            column = @Column( name = "GTP_TIMEGATEINOK")
		        ), 
		        @AttributeOverride(
			            name = "gateOutClerk",
			            column = @Column( name = "GTP_GATEOUTCLERKID")
			    ),
		        @AttributeOverride(
			            name = "timeGateOut",
			            column = @Column( name = "GTP_TIMEGATEOUT")
			    ),
		        @AttributeOverride(
			            name = "timeGateOutOk",
			            column = @Column( name = "GTP_TIMEGATEOUTOK")
			    ),
		        @AttributeOverride(
			            name = "eirNumber",
			            column = @Column( name = "GTP_EIRNO")
			    ), 
		        @AttributeOverride(
			            name = "eirStatus",
			            column = @Column( name = "GTP_EIRSTATUS")
			    ), 
		        @AttributeOverride(
			            name = "gateInClient",
			            column = @Column( name = "CLI_CLIENTID_GATEIN")
			    ), 
		        @AttributeOverride(
			            name = "gateOutClerk",
			            column = @Column( name = "CLI_CLIENTID_GATEOUT")
			    ), 
		        @AttributeOverride(
			            name = "impExpFlag",
			            column = @Column( name = "GTP_IMPEXPFLAG")
			    ), 
		        @AttributeOverride(
			            name = "rejectReason",
			            column = @Column( name = "GTP_REJECTREASON")
			    ),
		        @AttributeOverride(
			            name = "pmHeadNo",
			            column = @Column( name = "GTP_TRUCK_HEAD_NO")
			    ),
		        @AttributeOverride(
			            name = "pmPlateNo",
			            column = @Column( name = "GTP_TRUCK_PLATE_NO")
			    ),
		        @AttributeOverride(
			            name = "kioskConfirmed",
			            column = @Column( name = "KIOSK_CONFIRMED")
			    ),
		        @AttributeOverride(
			            name = "kioskCancelPickUp",
			            column = @Column( name = "KIOSK_CANCEL_PICKUP")
			    ),
		        @AttributeOverride(
			            name = "transactionSlipPrinted",
			            column = @Column( name = "TRANSACTION_SLIP_PRINTED")
			    ),
		        @AttributeOverride(
			            name = "gateOutBoothNo",
			            column = @Column( name = "GTP_GATE_OUT_BOOTH_NO")
			    ),
		        @AttributeOverride(
			            name = "gateOutBoothClerk",
			            column = @Column( name = "GTP_GATEOUT_BOOTH_CLERKID")
			    ),
		        @AttributeOverride(
			            name = "timeGateOutBooth",
			            column = @Column( name = "GTP_TIMEGATEOUT_BOOTH")
			    ),
		        @AttributeOverride(
			            name = "gateInStatus",
			            column = @Column( name = "GTP_GATEIN_STATUS")
			    ),
	...
	@AttributeOverrides({
		        @AttributeOverride(
		            name = "seal01Origin",
		            column = @Column( name = "GTP_SEAL_1_ORIGIN")
		        ),
		        @AttributeOverride(
		            name = "seal01Type",
		            column = @Column( name = "GTP_SEAL_1_TYPE")
		        ),
		        @AttributeOverride(
			            name = "seal01Number",
			            column = @Column( name = "GTP_SEAL_1_NO")
			    ),
		        @AttributeOverride(
			            name = "seal02Origin",
			            column = @Column( name = "GTP_SEAL_2_ORIGIN")
			    ),
		        @AttributeOverride(
			            name = "seal02Type",
			            column = @Column( name = "GTP_SEAL_2_TYPE")
			    ),
		        @AttributeOverride(
			            name = "seal02Number",
			            column = @Column( name = "GTP_SEAL_2_NO")
			    )
	})
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "GTP_HCID", nullable = true, referencedColumnName = "PRINT_NO")
