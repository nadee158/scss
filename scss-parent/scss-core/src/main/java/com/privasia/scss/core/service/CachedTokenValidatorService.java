...
public class CachedTokenValidatorService {
	...
	public void addTokenDetailsToCache(String token, String refreshToken, UserContext userContext) {
		System.out.println("ADDING TOKENS TO REDIS :" + " :token: " + token
				+ " :refreshToken: " + refreshToken + " :userName: " + userContext.getUsername());
		try {
	...
	public void updateTokenDetailsOfCache(String oldToken, String newtoken, String refreshToken,
		...
		try {
			System.out.println("UPDATING TOKENS TO REDIS :" + " :refreshToken: " + refreshToken
					+ " :oldToken: " + oldToken + " :newtoken: " + newtoken + " :userName: "
	...
	public void deleteTokenDetailsFromCache(String token, String refreshToken, String userName) {
		try {
			System.out.println("DELETING TOKENS :" + " :token: " + token + " :refreshToken: " + refreshToken
					+ " :userName: " + userName);
			String key = userName;
