...
public class ExportGateInService {
  ...
  public void updateReferReject(GateInWriteRequest gateInWriteRequest,
     ...
     * 
     * HttpEntity<ReferRejectDetailDTO> request = new HttpEntity<ReferRejectDetailDTO>(detailDTO,
     * headers);
     * 
     * log.info("OpusGateInReadRequest : -" + (new Gson()).toJson(detailDTO));
     * 
     * ResponseEntity<ApiResponseObject> response = restTemplate.postForEntity(updateReferDetailURL,
     * request, ApiResponseObject.class);
     * 
