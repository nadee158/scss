...
public class LogCosmosRequestAspect {
  ...
  public void isADGContainer(JoinPoint joinPoint, ISaDG isaDG) {
    ...
    if (joinPoint.getArgs()[0] instanceof GateInWriteRequest) {
      ...
      List<ExportContainer> dgContainers = gateInWriteRequest.getExportContainers().stream()
          .filter(exports -> StringUtils.isNotEmpty(exports.getImdg()) && exports.isDontValidateDg())
