...
public class ODDGateInService {
  ...
  public GateInResponse saveODDGateInInFo(GateInWriteRequest gateInWriteRequest) {
        ...
        switch (impExpFlag) {
          case IMPORT:
            Optional<ODDImportReason> optODDImportReason =
                oddImportReasonRepository.findOne(whODDdto.getContainer01().getRejectionReasonID());
            if (optODDImportReason.isPresent()) {
              whODDdto.getContainer01().setRejectionReason(optODDImportReason.get().getImportReason());
            } else {
              throw new BusinessException(
                  "Rejection Reason cannot be found for container  : " + whODDdto.getContainer01().getContainerNo());
            }
            if (whODDdto.getContainer02() != null) {
              ...
              if (optODDImportReason.isPresent()) {
                ...
                throw new BusinessException(
                    "Rejection Reason cannot be found for container  : " + whODDdto.getContainer02().getContainerNo());
              }
            }
            break;
          ...
          case EXPORT:
            ...
            Optional<ODDExportReason> optODDExportReason =
                oddExportReasonRepository.findOne(whODDdto.getContainer01().getRejectionReasonID());
    ...
    gateInResponse.setLaneNo(clientOpt.get().getLaneNo());
