...
public class KioskBoothController {
	...
	@RequestMapping(value = "/locktrx", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	@RequestMapping(value = "/completetrx", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	@RequestMapping(value = "/lockedkioskboothinfo/{kioskID}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	@RequestMapping(value = "/boothaccessright", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public CustomResponseEntity<ApiResponseObject<?>> getBoothAccessRight(
		...
		List<KioskBoothRightsDTO> kioskBoothRightInfos = kioskBoothService.getBoothAccessRight(boothID, kioskID,
				cardNumber);
		return new CustomResponseEntity<ApiResponseObject<?>>(
				new ApiResponseObject<List<KioskBoothRightsDTO>>(HttpStatus.OK, kioskBoothRightInfos), HttpStatus.OK);
	}

	@RequestMapping(value = "/kiosklistbybooth/{boothID}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	@RequestMapping(value = { "/searchkioskbooth/{cardNumber}/[{kioskLockStatusList}]",
			"/searchkioskbooth/{cardNumber}",
			"/searchkioskbooth/[{kioskLockStatusList}]" }, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public ResponseEntity<ApiResponseObject<?>> searchKioskBooth(
		...
		List<KioskBoothRightsDTO> kioskBoothRightsDTOs = kioskBoothService.searchKioskBooth(cardNumber,
				kioskLockStatusList);
		return new CustomResponseEntity<ApiResponseObject<?>>(
				new ApiResponseObject<List<KioskBoothRightsDTO>>(HttpStatus.OK, kioskBoothRightsDTOs), HttpStatus.OK);
	}
	
	@RequestMapping(value = "/updatekiosk", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_UTF8_VALUE, consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public CustomResponseEntity<ApiResponseObject<?>> updatelockedBootKiosk(
			@RequestBody KioskBoothRightsDTO kioskBoothRightsDTO) {
		String status = kioskBoothService.updateLockBoothTransaction(kioskBoothRightsDTO);
		return new CustomResponseEntity<ApiResponseObject<?>>(new ApiResponseObject<String>(HttpStatus.OK, status),
				HttpStatus.OK);
	}
