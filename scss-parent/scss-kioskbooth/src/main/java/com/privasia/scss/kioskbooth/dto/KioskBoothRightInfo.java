...
public class KioskBoothRightInfo implements Serializable {
	...
	public KioskBoothRightInfo(KioskBoothRights boothRights) {
		if (!(boothRights == null)) {
			if (!(boothRights.getKioskBoothRightsID() == null)) {
				if (!(boothRights.getKioskBoothRightsID().getBooth() == null)) {
					this.boothID = boothRights.getKioskBoothRightsID().getBooth().getClientID();
				}
				if (!(boothRights.getKioskBoothRightsID().getKiosk() == null)) {
					this.kioskID = boothRights.getKioskBoothRightsID().getKiosk().getClientID();
				}
			}
	...
	public String toString() {
		return "KioskBoothRightInfo [boothID=" + boothID + ", kioskID=" + kioskID + ", kioskLockStatus="
				+ kioskLockStatus + ", cardNumber=" + cardNumber + ", cardScanTime=" + cardScanTime
				+ ", kioskSelectedTime=" + kioskSelectedTime + ", displayScreenID=" + displayScreenID
				+ ", transactionIDList=" + transactionIDList + ", driverName=" + driverName + ", pmHeadNo=" + pmHeadNo
				+ ", truckCompany=" + truckCompany + ", driverIC=" + driverIC + ", plateNo=" + plateNo
				+ ", transactionType=" + transactionType + ", reviseHeadNo=" + reviseHeadNo + ", reviseHeadNoRemarks="
				+ reviseHeadNoRemarks + ", retakePhoto=" + retakePhoto + ", trxCompleteTime=" + trxCompleteTime
				+ ", lockUserID=" + lockUserID + ", lockUserName=" + lockUserName + ", referReason01List="
