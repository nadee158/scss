...
public class WHODDDTO implements Serializable {
  ...
  public String toString() {
    return "WHODDDTO [oddIdSeq=" + oddIdSeq + ", pmHeadNo=" + pmHeadNo + ", pmPlateNo=" + pmPlateNo
        + ", transactionSlipPrinted=" + transactionSlipPrinted + ", gateOutBoothNo=" + gateOutBoothNo + ", timeGateIn="
        + timeGateIn + ", timeGateInOk=" + timeGateInOk + ", timeGateOut=" + timeGateOut + ", timeGateOutOk="
        + timeGateOutOk + ", timeGateOutBooth=" + timeGateOutBooth + ", cardId=" + cardId + ", gateInClerkId="
        + gateInClerkId + ", gateOutClerkId=" + gateOutClerkId + ", gateInClientId=" + gateInClientId
        + ", gateOutClientId=" + gateOutClientId + ", gateOutBoothClerkId=" + gateOutBoothClerkId + ", impExpFlag="
        + impExpFlag + ", kioskCancelPickUp=" + kioskCancelPickUp + ", kioskConfirmed=" + kioskConfirmed
        + ", gateInStatus=" + gateInStatus + ", inOutFlag=" + inOutFlag + ", reviseHeadNoRem=" + reviseHeadNoRem
        + ", reviseHeadNo=" + reviseHeadNo + ", oldHeadNo=" + oldHeadNo + ", zipFileNo=" + zipFileNo + ", trxSlipNo="
        + trxSlipNo + ", container01=" + container01 + ", container02=" + container02 + "]";
  }
