...
public class ImportContainer implements Serializable {
	...
	private WDCGatePassDTO gcsDeclarationInfo;
	...
	public WDCGatePassDTO getGcsDeclarationInfo() {
		return gcsDeclarationInfo;
	}

	public void setGcsDeclarationInfo(WDCGatePassDTO gcsDeclarationInfo) {
		this.gcsDeclarationInfo = gcsDeclarationInfo;
	}
	...
	public String toString() {
		return "ImportContainer [gatePassID=" + gatePassID + ", gatePassNo=" + gatePassNo + ", gateOrderNo="
				...
				+ ", acceptOrReject=" + acceptOrReject + ", cugId=" + cugId + ", operationReefer=" + operationReefer
				+ ", temp=" + temp + ", tempUnit=" + tempUnit + ", imdg=" + imdg + ", unc=" + unc + ", oogoh=" + oogoh
				+ ", oogol=" + oogol + ", oogof=" + oogof + ", oogoa=" + oogoa + ", oogor=" + oogor + ", FOTBKGFlag="
				+ FOTBKGFlag + ", tareWeight=" + tareWeight + ", grossWeight=" + grossWeight + ", netWeight=" + netWeight 
				+ ", containerType=" + containerType + ", errXMLMsg="+ errXMLMsg + ", contRefer=" + contRefer 
				+ ", containerDischargeDateTime=" + containerDischargeDateTime
				+ ", impCarrierType=" + impCarrierType + ", impCarrier=" + impCarrier + ", vesselCode=" + vesselCode
				+ ", vesselVoyage=" + vesselVoyage + ", vesselVisitID=" + vesselVisitID + ", vesselScn=" + vesselScn
				+ ", vesselName=" + vesselName + ", vesselETADate=" + vesselETADate + ", vesselATADate=" + vesselATADate + ", damageCodeInfo=" + damageCodeInfo
				+ ", vesselStatus=" + vesselStatus + ", rtgExecustionStatus=" + rtgExecustionStatus + ", rtgExecustionDateTime=" + rtgExecustionDateTime
