...
public class ReferRejectListDTO implements Serializable {
  ...
  public String toString() {
    return "ReferRejectListDTO [referId=" + referId + ", boothNo=" + boothNo + ", pmHeadNo=" + pmHeadNo
        + ", haulierCompany=" + haulierCompany + ", driverName=" + driverName + ", referDateTime=" + referDateTime
        + ", contNo01=" + contNo01 + ", contNo02=" + contNo02 + ", doubleBooking=" + doubleBooking + "]";
  }
