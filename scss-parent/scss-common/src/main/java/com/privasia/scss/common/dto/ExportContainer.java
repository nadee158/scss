...
public class ExportContainer {
  ...
  public String toString() {
    return "ExportContainer [exportID=" + exportID + ", container=" + container + ", commonGateInOut=" + commonGateInOut
        ...
        + manualPlanIndicator + ", bookingNo=" + bookingNo + ", gateInOut=" + gateInOut + ", expOut=" + expOut
        ...
        + referTempType + ", referTemp=" + referTemp + ", imdg=" + imdg + ", dgUNCode=" + dgUNCode + ", imdgLabelID="
        ...
        + ", netWeight=" + netWeight + ", backToback=" + backToback + ", gateOutRemarks=" + gateOutRemarks
        ...
        + ", dontValidateSeal=" + dontValidateSeal + ", wrongDoor=" + wrongDoor + ", emptyWeight=" + emptyWeight
