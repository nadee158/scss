...
public class ExportContainer {
  ...
  public String toString() {
    return "ExportContainer [exportID=" + exportID + ", container=" + container + ", commonGateInOut=" + commonGateInOut
        ...
        + ", oogOR=" + oogOR + ", callCard=" + callCard + ", vesselVisitID=" + vesselVisitID + ", vesselVoyageIN="
        + vesselVoyageIN + ", vesselVoyageOUT=" + vesselVoyageOUT + ", vesselCode=" + vesselCode + ", vesselName="
        + vesselName + ", expAgent=" + expAgent + ", vesselStatus=" + vesselStatus + ", shipCode=" + shipCode
        + ", vesselSCN=" + vesselSCN + ", vesselETADate=" + vesselETADate + ", vesselATADate=" + vesselATADate
        + ", agentCode=" + agentCode + ", oogSSR=" + oogSSR + ", overClosingSSR=" + overClosingSSR + ", replanSSR="
        + replanSSR + ", ssrBlockStatus=" + ssrBlockStatus + ", ssrBlockStatusDate=" + ssrBlockStatusDate
        + ", gcsBlockStatus=" + gcsBlockStatus + ", gcsBlockStatusDate=" + gcsBlockStatusDate + ", gcsDeclareNo="
        + gcsDeclareNo + ", gcsLastCheck=" + gcsLastCheck + ", printEir=" + printEir + ", userRemarks=" + userRemarks
