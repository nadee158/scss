...
public class CustomsController {
  ...
  @RequestMapping(value = "/updatecustoms", method = RequestMethod.PUT,
      produces = MediaType.APPLICATION_JSON_UTF8_VALUE,
      consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
  public CustomResponseEntity<ApiResponseObject<?>> updateCustoms(
      @RequestBody CustomsDTO customsDTO) throws BindException {

    String result = customsService.updateCustoms(customsDTO);

    return new CustomResponseEntity<ApiResponseObject<?>>(
        new ApiResponseObject<String>(HttpStatus.OK, result), HttpStatus.OK);
  }

  @RequestMapping(value = "/checkcustomstatus/{clientID}", method = RequestMethod.GET,
      produces = MediaType.APPLICATION_JSON_UTF8_VALUE,
      consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
