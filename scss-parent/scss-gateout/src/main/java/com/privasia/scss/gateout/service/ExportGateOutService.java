...
public class ExportGateOutService {
	...
	public void checkSCN(ExportContainer exportContainer) throws Exception {
		Optional<ShipSCN> shipSCNOpt = shipSCNRepository
				.findByContainerNo(exportContainer.getContainer().getContainerNumber());
	...
	public void updateGateOutExport(List<ExportContainer> exportContainerList) {
		...
		Exports export = exportOpt.orElseThrow(() -> new ResultsNotFoundException("No valid Gate In Export Process found ! " + exportContainer.getExportID()));
		...
		ExportsQ exportq = exportQOpt.orElseThrow(() -> new ResultsNotFoundException("No valid Gate In ExportQ Process found ! " + exportContainer.getExportID()));
