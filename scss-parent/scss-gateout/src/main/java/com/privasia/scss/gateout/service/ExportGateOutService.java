  ...
  public List<Exports> testSolas(List<ExportContainer> exportsList) {
    ...
    if (exportsOptList.isPresent() && !exportsOptList.get().isEmpty()) {
      ...
      exportsOptList.get().forEach(exports -> {
        ...
        System.out.println("testSolas exports.getBaseCommonGateInOutAttribute().getGateInClerk() "
            + exports.getBaseCommonGateInOutAttribute().getGateInClerk());
        System.out.println("testSolas exports.getBaseCommonGateInOutAttribute().getGateInClient() "
            + exports.getBaseCommonGateInOutAttribute().getGateInClient());
