...
public class OpusService {
  ...
  public static List<OpusExporterContainer> constructOpusExporterContainersFromExporterContainers(
    ...
    List<OpusExporterContainer> exportContainerListCY = new ArrayList<OpusExporterContainer>();;
  ...
  public static List<OpusImportContainer> constructOpusImportContainersFromImportContainers(
    ...
    List<OpusImportContainer> importContainerListCY = new ArrayList<OpusImportContainer>();
  ...
  private static OpusImportContainer constructOpusImportContainer(ImportContainer importContainer) {
    if (!(importContainer == null)) {
      ...
      if (!(commonContainerDTO == null)) {
        ...
        opusImportContainer.setContainerNo(commonContainerDTO.getContainerNumber());
      }
      ...
      opusImportContainer.setPositionOnTruck(importContainer.getContainerPosition());
  ...
  public ImportContainer constructImportContainer(OpusImportContainer opusImportContainer,
    ...
    if (opusImportContainer != null) {
      ...
      importContainer
          .setRtgExecustionDateTime(DateUtil.getLocalDategFromString(opusImportContainer.getRtgExecustionDateTime()));
  ...
  private static OpusExporterContainer constructOpusExportContainer(ExportContainer exportContainer) {
    ...
    if (!(containerDTO == null)) {
      ...
      opusExporterContainer.setContainerHeight(Integer.toString(containerDTO.getContainerHeight()));
    }
    opusExporterContainer.setContainerType(exportContainer.getContainerType());
    opusExporterContainer.setGrossWeight(Integer.toString(exportContainer.getCosmosGrossWeight()));
    if (!(exportContainer.getExpNetWeight() == null)) {
      opusExporterContainer.setContainerNetWeight(Integer.toString(exportContainer.getExpNetWeight()));
    }
  ...
  public ExportContainer constructExportContainer(OpusExporterContainer opusExporterContainer,
    ...
    if (opusExporterContainer != null) {
      ...
      exportContainer
          .setRtgExecustionDateTime(DateUtil.getLocalDategFromString(opusExporterContainer.getRtgExecustionDateTime()));
      ...
      exportContainer
          .setYardOpeningDateTime(DateUtil.getLocalDategFromString(opusExporterContainer.getYardOpeningDateTime()));
      ...
      containerDTO.setContainerHeight(getIntValueFromString(opusExporterContainer.getContainerHeight()));
      // private String containerType;// GE,
      exportContainer.setContainerType(opusExporterContainer.getContainerType());
      // private double grossWeight;// 11000,
      exportContainer.setCosmosGrossWeight(getIntValueFromString(opusExporterContainer.getGrossWeight()));
      // private double containerNetWeight;// 9000,
      exportContainer.setExpNetWeight(getIntValueFromString(opusExporterContainer.getContainerNetWeight()));
      ...
      exportContainer
          .setYardDGOpeningDateTime(DateUtil.getLocalDategFromString(opusExporterContainer.getYardDGOpeningDateTime()));
