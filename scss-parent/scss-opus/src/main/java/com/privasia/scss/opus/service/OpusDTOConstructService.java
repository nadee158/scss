...
public class OpusDTOConstructService {
  ...
  public ExportContainer giReadResponseExporterContainerToExportContainer(
      GIReadResponseExporterContainer gIReadResponseExporterContainer, Optional<ExportContainer> optExportContainer) {
    ...
    exportContainer.setOogOH(
        ExportUtilService.getDoubleValueFromString(gIReadResponseExporterContainer.getContainerOOG_OH()).intValue());
    // private double containerOOG_OL;// 3.0,
    exportContainer.setOogOL(
        ExportUtilService.getDoubleValueFromString(gIReadResponseExporterContainer.getContainerOOG_OL()).intValue());
    // private double containerOOG_OF;// 1.0,
    exportContainer.setOogOF(
        ExportUtilService.getDoubleValueFromString(gIReadResponseExporterContainer.getContainerOOG_OF()).intValue());
    // private double containerOOG_OA;// 2.0,
    exportContainer.setOogOA(
        ExportUtilService.getDoubleValueFromString(gIReadResponseExporterContainer.getContainerOOG_OA()).intValue());
    // private double containerOOG_OR;// 4.0
    exportContainer.setOogOR(
        ExportUtilService.getDoubleValueFromString(gIReadResponseExporterContainer.getContainerOOG_OR()).intValue());
  ...
  public List<ExportContainer> giReadResponseExporterContainerListToExportContainerList(
    ...
    if (!(exportContainerListCY == null || exportContainerListCY.isEmpty())) {
      ...
      exportContainerListCY.forEach(opusExportContainer -> {
        ...
        exportContainer =
            giReadResponseExporterContainerToExportContainer(opusExportContainer, Optional.ofNullable(exportContainer));
  ...
  public List<ImportContainer> giReadResponseImportContainerListToImportContainerList(
    ...
    if (!(importContainerListCY == null || importContainerListCY.isEmpty())) {
      ...
      importContainerListCY.forEach(opusExportContainer -> {
        ...
        importContainer =
            giReadResponseImportContainerToImportContainer(opusExportContainer, Optional.of(importContainer));
