...
public class OpusDTOConstructService {
	...
	public ExportContainer giReadResponseExporterContainerToExportContainer(
		...
		exportContainer.setOogOH(
				ExportUtilService.getIntegerValueFromString(gIReadResponseExporterContainer.getContainerOOG_OH()));
		// private double containerOOG_OL;// 3.0,
		exportContainer.setOogOL(
				ExportUtilService.getIntegerValueFromString(gIReadResponseExporterContainer.getContainerOOG_OL()));
		// private double containerOOG_OF;// 1.0,
		exportContainer.setOogOF(
				ExportUtilService.getIntegerValueFromString(gIReadResponseExporterContainer.getContainerOOG_OF()));
		// private double containerOOG_OA;// 2.0,
		exportContainer.setOogOA(
				ExportUtilService.getIntegerValueFromString(gIReadResponseExporterContainer.getContainerOOG_OA()));
		// private double containerOOG_OR;// 4.0
		exportContainer.setOogOR(
				ExportUtilService.getIntegerValueFromString(gIReadResponseExporterContainer.getContainerOOG_OR()));
	...
	public List<ImportContainer> giReadResponseImportContainerListToImportContainerList(
		...
		if (!(importContainerListCY == null || importContainerListCY.isEmpty())) {
			...
			importContainerListCY.forEach(opusExportContainer -> {
				...
				importContainer = giReadResponseImportContainerToImportContainer(opusExportContainer, Optional.of(importContainer));
